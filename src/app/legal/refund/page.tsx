    ...
    <section className="bg-slate-50 dark:bg-slate-950 min-h-screen transition-colors">
      <div className="mx-auto max-w-4xl px-6 py-12 space-y-6">
        ...
        <div className="space-y-4 text-slate-800 dark:text-slate-200">
          ...
          <p>1.1. Услуги, предоставляемые на сайте ВАШ_ДОМЕН, являются цифровыми и оказываются онлайн.</p>
          ...
          <p>3.1. Для запроса возврата необходимо направить обращение на email: support@ВАШ_ДОМЕН с указанием даты оплаты, суммы и причины обращения.</p>
